...
import { selectAllProducts, selectTotalItems, selectCategory, selectBrand, fetchProductByFilterAsync, fetchCategoriesAsync, fetchBrandsAsync, selectProductSliceStatus } from '../productSlice'
import { useSelector, useDispatch } from 'react-redux';
import { ITEMS_PER_PAGE } from '../../../app/constants'
import ProductListSkeleton from '../../comman/SkeletonLoading/ProductListSkeleton'
import FeatureCarousel from '../../comman/FeatureCarousel'
        ...
        <div>
          ...
          <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-14">
              <h1 className="text-xl sm:text-3xl font-bold tracking-tight text-gray-900">New Arrivals</h1>
            ...
            <section aria-labelledby="products-heading" className="pb-24 pt-6">
              ...
              <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
                ...
                <div className="lg:col-span-3">
                  ...
                  <div className="bg-white">
                    {
                      products.length === 0 && <img src={ noProductImage } alt='noProductImage' />
                    }
                        ...
                        { status === 'loading' ?
                          ...
                          (products && products.map((product) => (
                            !product.deleted && (
                              ...
                              <div key={ product.id } className="group relative shadow-sm p-2 shadow-black">
                                <Link to={ `/product-detail/${product.id}` }>
                                  ...
                                  <div className="mt-4 flex justify-between">
                                    <div>
                                      ...
                                      <div>
                                        <div>
                                          <StarIcon className="w-4 h-4 text-gray-500 inline" />
                                          <p className="mt-1 text-sm text-gray-500 inline align-bottom">{ product.rating }</p>
                                        </div>
                                      </div>
                                    </div>
                                    <div>
